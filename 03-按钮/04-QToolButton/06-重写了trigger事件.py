...
# # 可以添加数据 就不用给每个action添加triggered的处理函数
# # open_action.triggered.connect()
# open_action.setData([1, 2, 3])

# QToolButton 重写了triggered
# btn.triggered.connect(btn_trigger)
# def btn_trigger(act: QAction):
#     print(act.data())
...
def main():
    ...
    about_action.setData('关于')
    exit_action = QAction("退出", menus)
    exit_action.setData('退出')
